                      ...
                      <#list ps.list as house> 
                            ...
                            <div class="property">
                                ...
                                <div class="property-image">
                                    ...
                                    <a href="/templates/house/detail?id=${house.id}">
                                ...
                                <div class="info">
                                    <header>
                                        <a href="/templates/house/detail?id=${house.id}"><h3>${house.name}</h3></a>
                                    ...
                                    <a href="/templates/house/detail?id=${house.id}" class="link-arrow">Read More</a>
                                </div>
                            </div>
                        </#list>
                       </section>
                ...
                <div class="col-md-3 col-sm-3">
                    <section id="sidebar">
                        <aside id="edit-search">
                            ...
                            <form role="form" id="searchForm" class="form-search" method="post" action="/templates/house/list">
                        ...
                        <aside id="featured-properties">
                            ...
                            <div class="property small">
                                ...
                                <div class="info">
                                    <a href="/templates/house/detail?id=${house.id}"><h4>${(house.name)!}</h4></a>
                                    <figure>${(house.address)!} </figure>
                                    <div class="tag price">￥${(house.price)!} 万</div>
                                </div>
                            </div><!-- /.property -->
